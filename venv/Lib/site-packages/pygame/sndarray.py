...
"""pygame module for accessing sounds sample data
...
A stereo sounds file has two values per sample, while a mono sounds file
only has one.

Sounds with 16-bit data will be treated as unsigned integers,
if the sounds sample type requests this.
"""
...
def array(sound):
    ...
    Creates a new array for the sounds data and copies the samples. The
